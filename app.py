...
st.markdown("<div style='font-size: 15px; font-weight: bold; color: #8b7d6b; letter-spacing: 3px; text-shadow: 1px 1px 3px rgba(0,0,0,0.15); margin-bottom: 5px;'>みなみしょうじ先生の幸せのひとり言</div>", unsafe_allow_html=True)
